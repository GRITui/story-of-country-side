...
## Current Focus
ENG-19 (Relationship System) shipped and merged — PR #34, merged directly
by the repo owner, issue #19 closed by owner. RelationshipManager autoload
(friendship points, once-per-day talk/gift caps, threshold-based heart
events) + GiftPreferenceTable resource now live in the base branch. Idle
between epochs — next pull should be one of the now-unblocked tasks below.
...
* PR #34 (merged): ENG-19 — RelationshipManager + GiftPreferenceTable.
...
- ENG-20 (Marriage) is READY_FOR_PM now — ENG-19 merged.
